...
## 2.1 Text-Mining
  ...
  In the shiny app, users can casually key in any character inside text box. The system will auto appear the suggested next predictive words in table format by follow the most accurate in sequence.
